...
<table border="0"><tr>
  <td>
    ...
    <ul>
      ...
      <li><a href="#models">`classes` for your models</a>
      <li><a href="#json-spec">`any code` for your JSON specs</a>
    </ul>
  </td>
</tr></table>
...
If you do not like the model generated by this class, you can write your own spec and template. See [JSON spec](#json-spec).
